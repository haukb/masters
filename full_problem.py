...
class Full_problem:
    ...
    def _build_objective(self):
        ...
        self.data.investment_costs = investment_costs = gp.quicksum(PROB_SCENARIO.iloc[0,s]*(
        ...
        for n in N_s[s])) for s in S)

        self.data.vessel_opex = vessel_opex = gp.quicksum(PROB_SCENARIO.iloc[0,s]*
        ...
        self.data.truck_opex = truck_opex = gp.quicksum(PROB_SCENARIO.iloc[0,s]*
        ...
        self.data.total_costs = total_costs = investment_costs + truck_opex + vessel_opex
